...
The offset core and model-specific Rice--Mele symmetry module are imported
explicitly below. The definitions of D and V are mathematical; an operational
state-discrimination interpretation is separate.
-/

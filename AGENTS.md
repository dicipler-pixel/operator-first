...
Read `ACTIVE_WORK.md`, `MASTER_STATUS.md`, `BRANCH_STATUS.md`, `catalog/POLICY.md`, and the current Compound Eye handoff before changing this project. Fetch GitHub branches and inspect open PRs before relying on a remembered release number, branch count, theorem count, or active head. Independent chats may extend different ancestors.

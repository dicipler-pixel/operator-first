...
def main():
    ...
    assert counts['eye_versions'] == len(registry.eyes) == 204
    assert counts['sets'] == len(registry.sets) == 32
    ...
    assert 'Universal 3.2' in page and '<b>204</b>eye versions' in page
